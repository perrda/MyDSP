...
export const RELEASE_NOTES: readonly ReleaseNotesEntry[] = [
  {
    ...
    bullets: [
      {
        text: 'A MacBook / iPhone / iPad size change, new holding, delete, or new/removed portfolio still lands on Mini boot, Backup, or the next minute — Mini never reverts it',
        to: '/settings#sync',
      },
      {
