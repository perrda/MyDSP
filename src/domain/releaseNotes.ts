...
export const RELEASE_NOTES: readonly ReleaseNotesEntry[] = [
  {
    ...
    bullets: [
      {
        text: 'A Kids book created, renamed, or deleted on Mini still lands when a MacBook size or channel changes — including a Kids, ETH, staking reward, or Kids → Children Mini already pushed; Mini never reverts it',
        to: '/settings#sync',
      },
      {
        text: 'Staking, FIRE, and budget edits survive absorb and dirty pull — Mini live prices stay, a deleted holding stays gone',
        to: '/settings#sync',
      },
      {
        text: 'Unlock, reload, or Pull book from Mini on MacBook / iPhone / iPad keeps an unpushed size, new ETH, Kids book, SOL delete, or channel — first Unlock still drops leftovers, including after a 1.2.163 upgrade (extras timestamp or lastPulledHoldingIds)',
        to: '/settings#sync',
      },
      {
  ...
  },
  {
    ...
    bullets: [
      {
        text: 'A MacBook / iPhone / iPad size change, new holding, delete, new/removed portfolio, or rename still lands on Mini boot, Backup, or the next minute — Mini never reverts it',
        to: '/settings#sync',
      },
      {
        text: 'YouTube / News / Markets extras still absorb first, then the book sizes',
  ...
  },
  {
    ...
    bullets: [
      {
        text: 'Mini pushes YouTube / News / Markets to the cloud on open — no Sync tap needed',
        to: '/settings#sync',
      },
      {
        text: 'Automatic can stay off; MacBook Unlock still pulls Mini’s list',
        to: '/youtube',
      },
      {
        text: 'Satellites still pull only — leftover lists never overwrite Mini',
        to: '/youtube',
      },
    ],
  },
  ...
  },
  {
    ...
    bullets: [
      {
        text: 'Unlock also fetches live FX and Markets marks, not only Mini’s last prints',
        to: '/markets',
      },
      {
        text: 'Holdings sizes and changes refresh after Unlock without tapping Refresh',
        to: '/settings#sync',
      },
      {
