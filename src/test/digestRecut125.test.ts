...
describe('MyDSP 1.2.125 digest recut', () => {
  ...
  it('period switcher is Daily / Weekly / Monthly / Quarterly / Annual', () => {
    ...
    expect(modal).toMatch(/Daily/)
    expect(modal).toMatch(/Weekly/)
    expect(modal).toMatch(/Monthly/)
    expect(modal).toMatch(/Quarterly/)
    expect(modal).toMatch(/Annual/)
