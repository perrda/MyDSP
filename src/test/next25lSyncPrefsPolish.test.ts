...
describe('next25l — sync prefs / Markets / Today polish tip (1–25 → v1.2.80)', () => {
  ...
  it('6–7: Equities/Crypto thumb + jump unavailable badge', () => {
    ...
    expect(equities).toMatch(/thumb-cta-bar|page-primary-actions|page-primary-create|PagePrimaryActions/)
    expect(crypto).toMatch(/thumb-cta-bar|page-primary-actions|page-primary-create|PagePrimaryActions/)
