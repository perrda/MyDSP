...
/** Pull-to-refresh on Today, Markets, holdings, News, YouTube, Tax, Compare, Todos, Jobs, Spending, Recurring, Liabilities, Goals, Trips, History, Budgets, Import, Family, Documents (no page jump). */
