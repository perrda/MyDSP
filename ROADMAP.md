...
**Current version: 1.2.133**

## Completed (through v1.2.133)

- Fluid-fit (v1.2.133): long display-CCY figures stay inside KPI / holding-detail / money / chart boxes at 390 · 768 · 1280 and landscape · container-query type + wrap, not clip · Today SIPP line = priced Equities sleeve (TSLA/MSTR, not accountType filter) · Mini-as-book + Today one-column / Assets hero + `#F7931A` kept · draft only — live stays 1.2.132
