...
**Current version: 1.2.149**

## Completed (through v1.2.149)

- YouTube channels unlock-and-pull (v1.2.149): satellite Unlock & pull on Today / YouTube / News / Markets runs `unlockAndPullFromCloud` (pull only) · Mini Backup now also pushes extras · unlocked satellite extras pull-then-push · display FX in the envelope · 1.2.148 live Refresh FX included · Mini favourites + book land · passphrase remembered · `#F7931A` + Mini-as-book kept
