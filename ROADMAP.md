...
**Current version: 1.2.110**

## Completed (through v1.2.110)

- No text overlap on holdings lists (v1.2.110): Equities/Crypto `.holdings-list-row` grid · `OverflowMenu compact` · Markets compact menus · `no-text-overlap.mdc`
