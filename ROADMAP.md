...
- Sitting satellite extras pull (v1.2.162): MacBook / iPhone / iPad left open with Automatic off still `doPull` Mini YouTube / News / Markets on focus / 60s / online (`maybePullSatelliteExtras`) · pull-only · live marks refresh after extras · Mini absorb (1.2.160) unchanged · `#F7931A` + Mini-as-book kept
