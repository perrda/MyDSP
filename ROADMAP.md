...
- Landscape nav clearance + 44px taps + CHARTS wrap (v1.2.165): short-landscape `padding-bottom` stays 5.5rem + safe-area so SIPP/liabilities, MIX, and Encrypted cloud sync clear the fixed bar · header menu / Refresh / More are 44×44 · Today jump chips wrap at 390 so CHARTS is fully readable · `#F7931A` + Mini-as-book kept · draft only — do not merge #206
