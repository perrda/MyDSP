...
**Current version: 1.2.148**

## Completed (through v1.2.148)

- Refresh fetches live FX (v1.2.148): header Refresh calls `fetchFxRates` before TSLA/MSTR/BTC/ADA quotes · exchangerate-api + CoinGecko · last-synced fills leftover £0 · Finnhub/Yahoo/CoinGecko cascade unchanged · Cloudflare $5 is not a data feed
